                        ...
                        <td>
                          <div class="dropdown">
                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                  @foreach($pricings as $pricing)
                                      @if($pricing->bookingHour) <!-- Only show if bookingHour exists -->
                                          <div class="dropdown-item d-flex justify-content-between align-items-center">
                                              <a href="{{ route('vendor.custom.pricing.edit', $pricing->id) }}" class="text-dark">
                                                  Edit {{ $pricing->bookingHour->hour }}hr
                                              </a>
                                              <a href="{{ route('vendor.custom.pricing.destroy.single', $pricing->id) }}" 
  ...
  <div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <form action="{{ route('vendor.custom.pricing.store') }}" method="POST">
          @csrf
