...
@section('content')
          ...
          <div class="d-flex gap-10 flex-wrap align-items-center justify-content-between">
            ...
            <div class="d-flex gap-10 flex-wrap align-items-center">
              ...
              <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                data-href="{{ route('admin.room_management.categories.bulk_delete') }}">
                        ...
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-secondary btn-sm mr-1  mt-1 editBtn" href="#" data-toggle="modal"
                              ...
                              data-status="{{ $category->status }}" data-language_id="{{ $category->language_id }}"
                            ...
                            <form class="deleteForm d-inline-block"
                              action="{{ route('admin.room_management.categories.delete', ['id' => $category->id]) }}"
                              method="post">
                              @csrf
  ...
  {{-- create modal --}}
  @include('admin.room-management.room-categories.create')

  {{-- edit modal --}}
  @include('admin.room-management.room-categories.edit')
@endsection
