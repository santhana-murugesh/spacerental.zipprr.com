        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-6 offset-lg-3">
              <form id="logoForm" action="{{ route('admin.pages.footer.update_logo') }}" method="POST"
    ...
    <div class="col-md-6">
      <div class="card">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-6 offset-lg-3">
              <form id="imageForm" action="{{ route('admin.pages.footer.update_background_image') }}" method="POST"
                enctype="multipart/form-data">
                @csrf
                <div class="form-group">
