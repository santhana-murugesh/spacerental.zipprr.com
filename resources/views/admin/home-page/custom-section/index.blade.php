          ...
          <div class="d-flex gap-10 flex-wrap align-items-center justify-content-between">
            ...
            <div class="d-flex gap-10 flex-wrap align-items-center">
              <a href="{{ route('admin.pages.home_page.additional_section.create') }}"
                class="btn btn-primary btn-sm float-right"><i class="fas fa-plus"></i> {{ __('Add') }}</a>

              <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                data-href="{{ route('admin.pages.home_page.additional_section.bulkdelete') }}">
                        ...
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-secondary btn-sm  mt-1 mr-1"
                              href="{{ route('admin.pages.home_page.additional_section.edit', ['id' => $sectoin->id]) }}">
                            ...
                            <form class="deleteForm d-inline-block"
                              action="{{ route('admin.pages.home_page.additional_section.delete', ['id' => $sectoin->id]) }}"
                              method="post">
                              @csrf
