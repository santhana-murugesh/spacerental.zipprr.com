    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxEditForm" class="modal-form"
          action="{{ route('admin.pages.home_page.hero_section.slider_version.update') }}" method="post"
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" name="text" rows="5" placeholder="{{ __('Enter Tex') }}t" id="in_text"></textarea>
          </div>
