                        ...
                        <tr>
                          ...
                          <td>
                            <form id="statusForm-{{ $offlineGateway->id }}" class="d-inline-block"
                              action="{{ route('admin.settings.payment_gateways.update_status', ['id' => $offlineGateway->id]) }}"
                              method="post">
                              @csrf
                              <select
                          ...
                          <td>
                            ...
                            <form class="deleteForm d-inline-block"
                              action="{{ route('admin.settings.payment_gateways.delete_offline_gateway', ['id' => $offlineGateway->id]) }}"
                              method="post">
                              @csrf
