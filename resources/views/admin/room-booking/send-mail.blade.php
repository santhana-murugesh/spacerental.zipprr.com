      ...
      <div class="modal-body">
        <form id="ajaxForm" action="{{ route('admin.room_bookings.send_mail') }}" method="POST">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="subject" placeholder="{{ __('Enter Email Subject') }}">
            <p id="err_subject" class="mt-1 mb-0 text-danger em"></p>
          </div>

          <div class="form-group">
            <label for="">{{ __('Message') . '*' }}</label>
            <textarea class="form-control summernote" id="messageBody" name="message" placeholder="{{ __('Enter Message') }}" data-height="150"></textarea>
