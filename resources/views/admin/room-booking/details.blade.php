...
@section('content')
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="payment-information">
            ...
            @if (!is_null($details->payment_method) && !empty($details->payment_method))
              <div class="row mb-2">
                <div class="col-lg-6">
            ...
            @elseif ($details->gateway_type)
              <div class="row mb-2">
                ...
                <div class="col-lg-6">
                  @if (is_numeric($details->gateway_type))
                    @php
                      $gateway = \App\Models\PaymentGateway\OfflineGateway::find($details->gateway_type);
                    @endphp
                    {{ $gateway ? $gateway->name : 'Gateway ID: ' . $details->gateway_type }}
                  @else
                    {{ $details->gateway_type }}
                  @endif
                </div>
              </div>
            @endif
            ...
            @if ($additional_services && is_array($additional_services) && count($additional_services) > 0)
              <div class="row mb-2">
                <div class="col-lg-6">
  ...
  @include('admin.room-booking.services')
@endsection
