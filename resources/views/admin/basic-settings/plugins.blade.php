...
@section('content')
  ...
  <div class="row">
    <div class="col-lg-4 col-md-6">
      <div class="card">
        <form action="{{ route('admin.settings.update_disqus') }}" method="post">
          @csrf
    ...
    <div class="col-lg-4 col-md-6">
      <div class="card">
        <form action="{{ route('admin.settings.update_tawkto') }}" method="post">
          @csrf
          <div class="card-header">
            <div class="row">
              <div class="col-lg-12">
    ...
    <div class="col-lg-4 col-md-6">
      <div class="card">
        <form action="{{ route('admin.settings.update_recaptcha') }}" method="post">
          @csrf
          <div class="card-header">
            <div class="row">
              <div class="col-lg-12">
    ...
    <div class="col-lg-4 col-md-6">
      <div class="card">
        <form action="{{ route('admin.settings.update_facebook') }}" method="post">
          @csrf
          <div class="card-header">
            <div class="row">
              <div class="col-lg-12">
    ...
    <div class="col-lg-4 col-md-6">
      <div class="card">
        <form action="{{ route('admin.settings.update_google') }}" method="post">
          @csrf
          <div class="card-header">
            <div class="row">
              <div class="col-lg-12">
    ...
    <div class="col-lg-4 col-md-6">
      <div class="card">
        <form action="{{ route('admin.settings.update_google_map_api') }}" method="post">
          @csrf
          <div class="card-header">
            <div class="row">
              <div class="col-lg-12">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <h6 class="mt-2 mb-1">{{ __('If the Google Maps API is disabled:') }}</h6>
                  <ul class="pl-20 mb-0">
                    <li><p class="mb-0 text-warning"> {{ __('Address suggestions will not be available in the location search input.') }}</p></li>
                    <li><p class="mb-0 text-warning">{{ __('Radius-based location searches will be non-functional.') }}</p></li>
                  </ul>
    ...
    <div class="col-lg-4 col-md-6">
      <div class="card">
        <form action="{{ route('admin.settings.update_whatsapp') }}" method="post">
          @csrf
          <div class="card-header">
            <div class="row">
              <div class="col-lg-12">
