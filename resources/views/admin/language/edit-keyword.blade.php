    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          ...
          <a class="btn btn-info btn-sm float-right d-inline-block" href="{{ route('admin.settings.language_management') }}">
          ...
          <div class="row">
            <div class="col-lg-12">
              <form id="languageKeywordForm"
                action="{{ route('admin.settings.language_management.update_keyword', ['id' => $language->id]) }}" method="post">
                @csrf
