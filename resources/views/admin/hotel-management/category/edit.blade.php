    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxEditForm" class="modal-form"
          action="{{ route('admin.hotel_management.category.update') }}" method="post"
          ...
          <div class="form-group">
            ...
            <textarea id="in_icon" class="form-control" name="icon" rows="3" placeholder="{{ __('Enter SVG code or emoji (e.g., 🏢, 🏨, 🏪)') }}"></textarea>
