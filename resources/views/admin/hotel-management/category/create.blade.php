  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxForm" class="modal-form create" action="{{ route('admin.hotel_management.category.store') }}"
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" name="icon" rows="3" placeholder="{{ __('Enter SVG code or emoji (e.g., 🏢, 🏨, 🏪)') }}"></textarea>
            <p id="err_icon" class="mt-2 mb-0 text-danger em"></p>
            <small class="text-muted">{{ __('You can use emojis, SVG code, or FontAwesome icons. Leave empty to use default icon.') }}</small>
          </div>
