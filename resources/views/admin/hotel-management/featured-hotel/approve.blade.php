...
@section('content')
  <div class="page-header">
    <h4 class="page-title">{{ __('Approved') }}</h4>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-lg-10">
              <form id="searchForm" action="{{ route('admin.hotel_management.featured_hotel.approved_request') }}"
                method="GET">
                <div class="row">
                  <div class="col-lg-3">
                          ...
                          <td>
                            @if ($order->order_status == 'pending')
                              <form id="orderStatusForm-{{ $order->id }}" class="d-inline-block"
                                ...
                                <select
                                  ...
                                  <option value="apporved">{{ __('Apporved') }}</option>
                            ...
                            @else
                              <h2 class="d-inline-block"><span
                                  ...
                                  {{ $order->order_status == 'apporved' ? 'approved' : $order->order_status }}
                                </span>
                              </h2>
                            @endif
                          </td>
