              ...
              <div class="col-lg-8">
                <div class="form-group">
                  <div class="selectgroup selectgroup-pills">
                    ...
                    <label class="selectgroup-item">
                      <input type="checkbox" class="selectgroup-input" name="permissions[]" value="Venues Management"
                        @if (is_array($rolePermissions) && in_array('Venues Management', $rolePermissions)) checked @endif>
                      <span class="selectgroup-button">{{ __('Venues Management') }}</span>
                    </label>
                    <label class="selectgroup-item">
