          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
              ...
              <form id="ajaxEditForm"
                action="{{ route('admin.vendor_management.update_vendor_balance', ['id' => $vendor->id]) }}"
                method="post">
                @csrf
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <p id="editErr_amount_status" class="mt-2 mb-0 text-danger em"></p>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      <label>{{ __('Amount') }} ({{ $settings->base_currency_text }})</label>
