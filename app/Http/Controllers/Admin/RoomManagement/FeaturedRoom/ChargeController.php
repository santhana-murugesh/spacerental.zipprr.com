...
class ChargeController extends Controller
{
    ...
    {
        $information['charges'] = FeaturedRoomCharge::orderBy('id', 'desc')->get();
        return view('admin.room-management.featured-room.charge.index', $information);
    }
    public function store(Request $request)
    {
        ...
        FeaturedRoomCharge::query()->create($request->except('language'));
    ...
    public function update(Request $request)
    {
        ...
        $chargeInfo = FeaturedRoomCharge::query()->find($request->id);
    ...
    public function destroy($id)
    {
        ...
        $charge = FeaturedRoomCharge::query()->find($id);
