...
class BasicController extends Controller
{
    ...
    public function hotelTaxAmount()
    {
        $data = DB::table('basic_settings')->select('hotel_tax_amount')->first();

        return view('admin.room-management.tax', ['data' => $data]);
    }

    public function updateHotelTaxAmount(Request $request)
    {
        $rules = [
            'hotel_tax_amount' => 'required|numeric'
        ];
        ...
        DB::table('basic_settings')->updateOrInsert(
            ['uniqid' => 12345],
            ['hotel_tax_amount' => $request->hotel_tax_amount]
        );
    ...
    public function update_general_setting(Request $request)
    {
        ...
        $rules = [
            ...
            'base_currency_symbol' => 'required|max:255',
            'base_currency_symbol_position' =>  'required|max:255',
            'base_currency_text' => 'required|max:255',
            'base_currency_text_position' => 'required|max:255',
