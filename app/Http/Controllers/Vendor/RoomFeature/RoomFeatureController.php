...
use App\Http\Controllers\Vendor\RoomFeature\PayPalController;
use App\Http\Controllers\Vendor\RoomFeature\OfflineController;
...
class RoomFeatureController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request['gateway'] == 'paypal') {
            ...
            $cancel_url = route('vendor.room_management.room.purchase_feature.iyzico.cancle');
