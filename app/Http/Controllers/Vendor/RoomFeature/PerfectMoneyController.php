...
class PerfectMoneyController extends Controller
{
    ...
    public static function index(Request $request, $event_id)
    {
        ...
        $val['STATUS_URL'] = route('vendor.room_management.room.purchase_feature.perfect_money.notify');
        $val['PAYMENT_URL'] = route('vendor.room_management.room.purchase_feature.perfect_money.notify');
