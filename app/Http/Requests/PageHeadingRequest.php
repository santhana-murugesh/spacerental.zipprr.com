...
class PageHeadingRequest extends FormRequest
{
  ...
  {
    return [
      'hotel_page_title' => 'required',
      'hotel_details_page_title' => 'required',
      'rooms_page_title' => 'required',
      'room_details_page_title' => 'required',
      ...
      'room_wishlist_page_title' => 'required',
      'hotel_wishlist_page_title' => 'required',
      'room_bookings_page_title' => 'required',
      'room_booking_details_page_title' => 'required',
